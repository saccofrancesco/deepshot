...
today: datetime.datetime = f"{year}-10-20"
        ...
        with date_container:
            with ui.column(align_items="center"):
                ...
                date_picker: ui.date = (
                    ...
                    .props(
                        '''minimal color=orange-14 :options="date => {const d = new Date(date); const start = new Date('2026-10-19'); const end = new Date('2027-04-11'); return d >= start && d <= end;}"'''
                    )
                    .classes("mt-2")
                )
